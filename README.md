# 1. 프로그래밍 관련
### REST API
- [REST API 개념 및 설명](https://meetup.toast.com/posts/92)
...
- [Dependency Injection 장점](https://medium.com/@jang.wangsu/di-dependency-injection-이란-1b12fdefec4f)
- [Dependency Injection 개념 및 설명](https://poqw.github.io/di_1/)
